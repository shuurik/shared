...
class AmazonScraper(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://www.amazon.com/s?k=voltage"]
    ...
    def parse(self, response):
        ...
        for mobile in mobiles:
            ...
            yield scrapy.Request(url=final_url, callback = self.parse_mobile)
    ...
    def parse_mobile(self, response):
        ...
        print(title, brand, rating, rank, price, colour, instock, img_url)
        # print(final_review)
        # print(reviews)
        # print(description)

        yield Mobile(title = title.strip(), brand = brand.strip(), rating = rating.strip(), rank = rank.strip(), price = price.strip(), colour = colour.strip(), instock = instock, reviews = reviews, description = description, image_urls = [img_url])